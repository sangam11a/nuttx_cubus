...
//     if (rd_flags_int.ANT_DEP_STAT == 0xff && (read_size_mfm == 0 || read_size_mfm != sizeof(CRITICAL_FLAGS)))
//     {
...
//     }
//     else if (rd_flags_int.ANT_DEP_STAT == 0xff)
//     {
//         syslog(LOG_INFO, "Flag data available in main flash only. Copying to internal flash.\n");
//         critic_flags = rd_flags_mfm;
//         store_flag_data(&critic_flags);
//     }
//     else if (read_size_mfm == 0 || read_size_mfm != sizeof(CRITICAL_FLAGS))
//     {
//         syslog(LOG_INFO, "Flag data available in internal flash only. Copying to main flash.\n");
//         critic_flags = rd_flags_int;
//         store_flag_data(&critic_flags);
//     }
//     else if (memcmp(&rd_flags_int, &rd_flags_mfm, sizeof(CRITICAL_FLAGS)) != 0)
//     {
//         syslog(LOG_INFO, "Inconsistency detected between internal and main flash data.\nUsing internal flash data.\n");
//         critic_flags = rd_flags_int;
//         store_flag_data(&critic_flags);
//     }
//     else
//     {
//         syslog(LOG_INFO, "Data is consistent between internal and main flash.\n");
//         critic_flags = rd_flags_int;
//     }

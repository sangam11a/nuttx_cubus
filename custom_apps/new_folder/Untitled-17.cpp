...
pthread_mutex_t internal_flash_mutex =  PTHREAD_MUTEX_INITIALIZER;
...
int clear_int_flag(){
  ...
  struct file fp;
  int fd;
  pthread_mutex_lock(&internal_flash_mutex); // Lock the mutex
  ...
  // file_close(&fp);
  pthread_mutex_unlock(&internal_flash_mutex); // Lock the mutex
